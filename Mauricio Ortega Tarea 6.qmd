...
plt.xlabel("t")
plt.ylabel("y")
plt.title("Solución aproximada de $y' = t - t y$")
plt.grid()
plt.legend()
plt.show()
```
...
s0 = np.array([1, -1])
t_values = np.linspace(t0, tf, 1000)
edo_sol = integrate.solve_ivp(
    f, [t0, tf], s0, t_eval=t_values, method='LSODA'  # Cambia el método si quieres
)

print("Solución exitosa:", edo_sol.success)
print("Shape t_eval:", t_values.shape)
print("Shape t calculada:", edo_sol.t.shape)
print("Shape y[0]:", edo_sol.y[0].shape)
...
def f(t, U):
    y, yp = U
    return [yp, -np.pi**2*y + np.cos(2*np.pi*t)]
...
plt.xlabel("x(t)")
plt.ylabel("y(t)")
plt.title("Trayectoria seno-coseno")
plt.grid()
plt.legend()
plt.show()
```
...
print("edo_sol.t.shape:", edo_sol.t.shape)
print("edo_sol.y[0].shape:", edo_sol.y[0].shape)
print("edo_sol.y[1].shape:", edo_sol.y[1].shape)
...
plt.xlabel("x(t)")
plt.ylabel("y(t)")
plt.title("Trayectoria sistema no autónomo")
plt.grid()
plt.legend()
plt.show()
```
...
plt.xlabel("x(t)")
plt.ylabel("y(t)")
plt.title("Trayectoria crecimiento logístico cruzado")
plt.grid()
plt.legend()
plt.show()
```
...
plt.xlabel("x(t)")
plt.ylabel("y(t)")
plt.title("Trayectoria campo no lineal")
plt.grid()
plt.legend()
plt.show()
```
...
plt.xlabel("x(t)")
plt.ylabel("y(t)")
plt.title("Trayectoria sistema acoplado")
plt.grid()
plt.legend()
plt.show()
```
